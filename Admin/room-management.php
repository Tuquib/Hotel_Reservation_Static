...
<body>
  ...
  <div class="container">
    <a href="#" class="edit-icon" style="height: 45px; width: 45px;"><i class="fa fa-edit"></i></a>
    ...
    <a href="#" class="edit-icon" style="top: 580px; right: 40px;"><i class="fa fa-edit"></i></a></span>
    <div class="row justify-content-center">
      <div class="col-md-4">
    ...
    <div class="reserve">
      <a href="admin-dashboard.php">
        <button style="width: 80px" type="submit" class="btn btn-success">
          OK
        </button>
      </a>
    </div>
